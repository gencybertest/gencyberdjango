...
define('myproject/models/poto', ['exports', 'ember-data'], function (exports, DS) {
...
define('myproject/routes/login', ['exports', 'ember'], function (exports, Ember) {
...
define('myproject/templates/login', ['exports'], function (exports) {
...
define('myproject/tests/models/poto.jshint', function () {

  'use strict';

  module('JSHint - models');
  test('models/poto.js should pass jshint', function() { 
    ok(true, 'models/poto.js should pass jshint.'); 
  });
...
define('myproject/tests/routes/login.jshint', function () {
...
define('myproject/tests/unit/models/poto-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleForModel('poto', 'Unit | Model | poto', {
    // Specify the other units that are required for this test.
    needs: []
  });
...
define('myproject/tests/unit/models/poto-test.jshint', function () {

  'use strict';

  module('JSHint - unit/models');
  test('unit/models/poto-test.js should pass jshint', function() { 
    ok(true, 'unit/models/poto-test.js should pass jshint.'); 
  });

});
define('myproject/tests/unit/routes/login-test', ['ember-qunit'], function (ember_qunit) {
...
define('myproject/tests/unit/routes/login-test.jshint', function () {
...
if (runningTests) {
  ...
  require("myproject/app")["default"].create({"name":"myproject","version":"0.0.0.02a023b3"});
}
